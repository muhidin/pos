...
--
-- Host: localhost:3306
-- Generation Time: Feb 21, 2020 at 11:59 PM
...
CREATE TABLE `barang` (
  ...
  `hargajual_grosir` double DEFAULT NULL,
...
INSERT INTO `barang` (`id`, `nama`, `satuan`, `hargapokok`, `hargajual`, `hargajual_grosir`, `stok`, `min_stok`, `tgl_input`, `tgl_last_update`, `kategori_id`, `user_id`) VALUES
...
CREATE TABLE `detail_jual` (
  ...
  `barang_hargapokok` double DEFAULT NULL,
  `barang_hargajual` double DEFAULT NULL,
...
INSERT INTO `detail_jual` (`id`, `nofaktur`, `barang_id`, `barang_nama`, `barang_satuan`, `barang_hargapokok`, `barang_hargajual`, `qty`, `diskon`, `total`) VALUES
...
INSERT INTO `jual` (`nofaktur`, `tanggal`, `total`, `jumlah_uang`, `kembalian`, `user_id`, `keterangan`) VALUES
...
CREATE TABLE `setting` (
  ...
  `slogan` varchar(75) DEFAULT NULL,
  `logo` varchar(75) DEFAULT NULL,
  `logokecil` varchar(75) DEFAULT NULL,
  `footerl` varchar(100) DEFAULT NULL,
  `footerr` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `setting` (`id`, `nama`, `slogan`, `logo`, `logokecil`, `footerl`, `footerr`) VALUES
(1, 'Programming 1', 'StudentDay Web Programming', 'logo2.png', 'logo.png', 'StudentDay <a href=\"http://muhidin.web.id\">Web Programming</a>', '<a href=\"http://smapluspgri.sch.id\">SMA Plus PGRI Cibinong</a>');
...
CREATE TABLE `user` (
  ...
  `level` varchar(1) DEFAULT NULL COMMENT '1=admin, 2=kasir',
  `status` varchar(1) DEFAULT '0' COMMENT '1=aktif, 0=tidak aktif',
...
INSERT INTO `user` (`id`, `nama`, `gender`, `username`, `password`, `level`, `status`, `email`, `foto`) VALUES
(1, 'Muhidin Saimin', 'L', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '1', '1', 'muhidins@gmail.com', 'muhidin.jpg'),
(2, 'Kasirah', 'P', 'kasir', '8691e4fc53b99da544ce86e22acba62d13352eff', '2', '1', 'muhidinsaimin@gmail.com', NULL),
(3, 'ari', 'l', 'yes', 'yes', '1', '1', NULL, NULL);
...
ALTER TABLE `barang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `barang_user_id` (`user_id`),
  ADD KEY `barang_kategori_id` (`kategori_id`);
...
ALTER TABLE `beli`
  ...
  ADD KEY `beli_user_id` (`user_id`),
  ADD KEY `beli_suplier_id` (`suplier_id`),
  ADD KEY `beli_id` (`kode`);
...
ALTER TABLE `detail_beli`
  ADD PRIMARY KEY (`id`),
  ADD KEY `d_beli_barang_id` (`barang_id`),
  ADD KEY `d_beli_nofak` (`nofaktur`),
  ADD KEY `d_beli_kode` (`kode`);
...
ALTER TABLE `detail_jual`
  ADD PRIMARY KEY (`id`),
  ADD KEY `d_jual_barang_id` (`barang_id`),
  ADD KEY `d_jual_nofak` (`nofaktur`);
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `barang_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `barang_ibfk_2` FOREIGN KEY (`kategori_id`) REFERENCES `kategori` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `beli`
--
ALTER TABLE `beli`
  ADD CONSTRAINT `beli_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `beli_ibfk_2` FOREIGN KEY (`suplier_id`) REFERENCES `suplier` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `detail_beli`
--
ALTER TABLE `detail_beli`
  ADD CONSTRAINT `detail_beli_ibfk_1` FOREIGN KEY (`barang_id`) REFERENCES `barang` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_beli_ibfk_2` FOREIGN KEY (`kode`) REFERENCES `beli` (`kode`) ON UPDATE CASCADE;

--
-- Constraints for table `detail_jual`
--
ALTER TABLE `detail_jual`
  ADD CONSTRAINT `detail_jual_ibfk_1` FOREIGN KEY (`barang_id`) REFERENCES `barang` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_jual_ibfk_2` FOREIGN KEY (`nofaktur`) REFERENCES `jual` (`nofaktur`) ON UPDATE CASCADE;

--
-- Constraints for table `jual`
--
ALTER TABLE `jual`
  ADD CONSTRAINT `jual_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE;
